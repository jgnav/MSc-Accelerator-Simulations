...
\input{header/include_pd}
 ...
 %% Declaration
\input{header/include_dc}
\cleardoublepage

 %% Abstract
\input{header/include_ab}

 %% Table of contents
\input{header/include_toc}

 %% Sections --------------------------------------------
\begin{refsection}
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_0_en}}		% Introduction
	{\include{contents/kapitel_0}} 	        % Einleitung
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_1_en}}		%
	{\include{contents/kapitel_1}} 	        %
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_2_en}}		%
	{\include{contents/kapitel_2}} 	        %
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/kapitel_3_en}}		%
	{\include{contents/kapitel_3}} 	        %
	%
	% {\include{contents/kapitel_4_en}}		%
	%
	\ifthenelse{\equal{\isenglish}{true}}%
	{\include{contents/theend}}		        % Conclusion
	{\include{contents/schluss}} 	        % Zusammenfassung
